...
public class setPrice {
	...
	public void set(@RequestBody Map<String,String> data) throws SQLException, ClassNotFoundException{
	...
	try {
		...
		String b=data.get("price");
	//	System.out.println(a);
		String sql="update  zhushi set price="+"'"+b+"'"+"where id="+"'"+a+"'";
